...
class StoreTenantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tenant_domain' => ['nullable', 'string', 'max:255', 'regex:/^(?=.{1,255}$)([a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?)(\.[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?)+$/', 'unique:schools,tenant_domain'],
            'tenant_database' => ['nullable', 'string', 'max:64', 'regex:/^[A-Za-z0-9_]+$/', 'unique:schools,tenant_database'],
